...
public class MainActivity extends AppCompatActivity {
    ...
    private int wordColumn, descriptionColumn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDescriptionTextView = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        if(mData != null) {
            ...
            mDescriptionTextView.setText(mData.getString(descriptionColumn));
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            descriptionColumn = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);
