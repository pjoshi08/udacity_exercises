...
public class NotificationUtils {
    ...
    private static final int IGNORE_REMINDER_PENDING_INTENT_ID = 3418;

    private static final int ACCEPT_REMINDER_PENDING_INTENT_ID = 3419;
    /**
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                context,
                ACCEPT_REMINDER_PENDING_INTENT_ID,
                drinkWaterIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action acceptReminderAction = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,
                "I Did It!",
                pendingIntent);
        //      COMPLETED (16) Return the action
        return acceptReminderAction;
    }
