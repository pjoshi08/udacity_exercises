...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String RAW_JSON = "jsonData";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            String query = savedInstanceState.getString(QUERY_URL);
            String jsonData = savedInstanceState.getString(RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(RAW_JSON, jsonData);
    }
}